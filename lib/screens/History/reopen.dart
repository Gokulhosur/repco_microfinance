...
class ReopenPage extends StatefulWidget {
  const ReopenPage({super.key});

  @override
  State<ReopenPage> createState() => _ReopenPageState();
}

class _ReopenPageState extends State<ReopenPage> {
  ...
  final List<LoanData> chartData = [
    LoanData(DateTime(2022, 05, 20), 8),
    LoanData(DateTime(2022, 05, 21), 34),
    LoanData(DateTime(2022, 05, 22), 14),
    LoanData(DateTime(2022, 05, 23), 13),
    LoanData(DateTime(2022, 05, 24), 14),
    LoanData(DateTime(2022, 05, 25), 25),
    LoanData(DateTime(2022, 05, 26), 27),
    LoanData(DateTime(2022, 05, 27), 20),
    LoanData(DateTime(2022, 05, 28), 26),
    LoanData(DateTime(2022, 05, 29), 8),
  ];
