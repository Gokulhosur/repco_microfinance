...
class _DraftPageState extends State<DraftPage> {
  ...
  final List<LoanData> chartData = [
    ...
    LoanData(DateTime(2022, 03, 25), 28),
    LoanData(DateTime(2022, 03, 26), 30),
    LoanData(DateTime(2022, 03, 27), 25),
    LoanData(DateTime(2022, 03, 28), 17),
    LoanData(DateTime(2022, 03, 29), 21),
    LoanData(DateTime(2022, 03, 30), 25),
    LoanData(DateTime(2022, 03, 31), 15),
    LoanData(DateTime(2022, 04, 01), 16),
