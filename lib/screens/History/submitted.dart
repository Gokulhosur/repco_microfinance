...
class _SubmittedPageState extends State<SubmittedPage> {
  ...
  final List<LoanData> chartData = [
    ...
    LoanData(DateTime(2022, 03, 25), 38),
    LoanData(DateTime(2022, 03, 26), 24),
    LoanData(DateTime(2022, 03, 27), 15),
    LoanData(DateTime(2022, 03, 28), 20),
    LoanData(DateTime(2022, 03, 29), 28),
    LoanData(DateTime(2022, 03, 30), 34),
    LoanData(DateTime(2022, 03, 31), 15),
    LoanData(DateTime(2022, 04, 01), 20),
